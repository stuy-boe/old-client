	...
	return (
		<div>
			<Helmet>
				...
				<meta property="og:title" content={`${election.name} | Stuy BOE Voting Site`}/>
				<meta property="og:description" content={`Overview of ${election.name}. Vote, view updates, learn about candidates and more.`}/>
			</Helmet>
